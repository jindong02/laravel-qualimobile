@section('title', 'Editar revestimento')
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.revestimento.post') }}" method="POST"  enctype="multipart/form-data" class="basic-card shadow">
                @csrf
                <input type="hidden" name="id" value="{{ $revestimento->id }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nome" value="{{ $revestimento->nome }}" required="">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Categoria</label>
                                <input type="text" class="form-control" name="categoria" value="{{ $revestimento->categoria }}" required="">
                            </div>
                            <div class="form-group">
