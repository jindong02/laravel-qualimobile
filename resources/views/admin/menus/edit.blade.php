...
<div class="container" style="min-height: calc(100vh - 147px);">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.menus.update', $menu) }}" method="POST" class="basic-card shadow" data-parsley-validate>
                @csrf
                @method('put')
                ...
                <div class="card-footer text-right">
                    ...
                    <a href="{{ route('admin.menus.index') }}" class="btn btn-default">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
