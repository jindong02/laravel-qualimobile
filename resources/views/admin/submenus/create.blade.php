...
<div class="container" style="min-height: calc(100vh - 147px);">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.submenus.store') }}" method="POST" class="basic-card shadow" data-parsley-validate>
                @csrf
                <div class="card-header">
                    <div class="card-head">
                        <div class="head-title"><h3 class="head-text">Novo submenu</h3></div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            >
                                ...
                                @foreach ($mainMenus as $mainMenu)
                                    <option
                                        value="{{ $mainMenu->id }}"
                                        {{ $mainMenu->id == old('menu_id') ? 'selected' : '' }}
                ...
                <div class="card-footer text-right">
                    ...
                    <a href="{{ route('admin.submenus.index') }}" class="btn btn-default">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
