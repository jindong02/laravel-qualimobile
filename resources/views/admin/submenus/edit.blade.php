...
<div class="container" style="min-height: calc(100vh - 147px);">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.submenus.update', $submenu) }}" method="POST" class="basic-card shadow" data-parsley-validate>
                @csrf
                @method('put')
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <select class="form-control select2" name="subcategoria_ids[]" multiple="multiple" data-placeholder="Todas as subcategorias">
                                <?php
                                    if (old('categoria_id')) {
                                        $produtoSubcategorias = \App\Models\Categoria::find(old('categoria_id'))->Subcategoria->all();
                                    }
                                ?>
