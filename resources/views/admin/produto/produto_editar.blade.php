...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.produto.post') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_sub_categoria">
                                    ...
                                    @foreach ($produto->Categoria->Subcategoria->all() as $subcategoria)
                                        <option
...
<script>
    ...
    $("select[name=id_categoria]").change(function() {
        ...
        $.getJSON("/admin/produto/subcategoria/" + this.value, function(data) {
