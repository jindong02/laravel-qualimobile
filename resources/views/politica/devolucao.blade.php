@section('title', __('Política de Devolução'))
@extends('layouts.app')
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('POLÍTICA DE DEVOLUÇÃO') }}</li>
            </ol>
        </nav>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row px-lg-5 px-1 py-4 text-dark g-0 align-items-center justify-content-center">
            <div class="col-12 col-lg-10 p-0">
                ...
                {!! Config::get('config.politica_devolucao') !!}
