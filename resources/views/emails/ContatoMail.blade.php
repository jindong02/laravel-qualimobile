                            ...
                            <tr>
                                <td class="wrapper">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <h3>{{ ucfirst(strtolower(preg_replace("/\s.*/", '', ltrim($form->nome)))) }} entrou em contato</h3>
                                                <ul>
                                                    <li>Nome: {{ strtoupper($form->nome) }}</li>
                                                    <li>Email: {{ $form->email }}</li>
                                                    <li>Telefone: {{ $form->telefone }}</li>
                                                    {{--<li>Nome do Produto: {{ $form->produto_nome }}</li>--}}
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-block">
                                        <span class="apple-link">{{ Config::get('config.nome_site') }}, {{ Config::get('config.endereco') }}</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
