    ...
    <div class="container d-none d-sm-block">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-column flex-sm-row">
                ...
                <li class="breadcrumb-item"><a href="{{ route('produtos') }}">{{ __('PRODUTOS') }}</a></li>
        ...
        <div class="row">
            <div class="col-12 col-lg-5 order-2 order-lg-1 mt-8 mt-sm-0">
                ...
                <div class="text-gray-dark mt-0 ml-3 d-none d-sm-block">
                    ...
                    <button id="button-orcamento" class="btn btn-lg btn-info py-3 rounded-0">
                        SOLICITAR ORÇAMENTO
                    </button>
...
<section class="py-6 d-none d-sm-block">
    <div class="container">
        ...
        <div class="owl-carousel owl-theme">
            ...
            <div class="item">
                <a href="{{ route('produto', $relacionado->slug) }}" class="card card-rel shadow rounded-0 m-2"
                    style="width: 100%;">
                    <div class="card-body"
